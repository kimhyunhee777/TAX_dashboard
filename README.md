...
4. **provisions.json / precedents.json / news_topics.json / clients.json 채우기**: 지금은
   실무에서 자주 쓰이는 세액공제·세액감면 조문(조세특례제한법·법인세법) 14건 + 손금불산입 관련
   조문(대손금·세금과공과금·기부금·기업업무추진비·업무용승용차·지급이자 등, 법인세법) 10건,
   관련 판례 검색어 16건, 관련 뉴스 검색어 17건이 들어있습니다. 손금불산입 항목은 업종을
   가리지 않고 대부분의 법인에 해당하는 내용이라 `"tags": ["전체"]`로 넣어뒀습니다.
